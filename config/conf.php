...
$currst = [
    'CURENTSTID' => 'current_status_id',
    'NAME' => 'current_status_name',
];
$daddrobj = [
    'ACTSTATUS' => 'address_object_active_status',
    'AOGUID' => 'address_object_gu_id',
    'AOID' => 'address_object_ao_id',
    'AOLEVEL' => 'address_object_ao_level',
    'AREACODE' => 'address_object_area_code',
    'AUTOCODE' => 'address_object_auto_code',
    'CENTSTATUS' => 'address_object_center_status',
    'CITYCODE' => 'address_object_city_code',
    'CODE' => 'address_object_code',
    'CURRSTATUS' => 'address_object_curr_status',
...
$eststat = [
    ...
    'SHORTNAME' => 'estate_status_short_name',
];
$hststat = [
    'HOUSESTID' => 'house_status_id',
    'NAME' => 'house_status_name',
];
$intvstat = [
    'INTVSTATID' => 'interv_status_id',
    'NAME' => 'interv_status_name',
];
$landmark = [
...
$ndoctype = [
    'NDTYPEID' => 'norm_doc_type_id',
    'NAME' => 'norm_doc_type_name',
];
$opstat = [
    'NAME' => 'operation_statuses_name',
    'OPERSTATID' => 'operation_statuses_id'
];
$room = [
    'ROOMID' => 'room_room_id',
    'ROOMGUID' => 'room_gu_id',
    'HOUSEGUID' => 'room_house_gu_id',
...
$socr = [
    ...
    'SCNAME' => 'address_object_type_short_name',
    'SOCRNAME' => 'address_object_type_name',
    'KOD_T_ST' => 'address_object_type_kod_t_st',
];
$strstat = [
    'STRSTATID' => 'structure_status_id',
    'NAME' => 'structure_status_name',
    'SHORTNAME' => 'structure_status_shortname',
];
$stead = [
    'STEADGUID' => 'stead_gu_id',
    'NUMBER' => 'stead_number',
