...
ALTER TABLE `fiasdb`.`landmark`
  ADD CONSTRAINT `fk_landmark_norm_doc`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_landmark_address_object`
...
ALTER TABLE `fiasdb`.`house`
  ...
  CONSTRAINT `fk_house_house_status`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_house_str_status`
