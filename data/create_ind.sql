...
CREATE INDEX `fk_stead_address_object_idx` ON `fiasdb`.`stead` (`stead_parent_gu_id` ASC);
...
--     ON UPDATE NO ACTION;
ALTER TABLE `fiasdb`.`stead`
  ADD CONSTRAINT `fk_stead_address_object`
    FOREIGN KEY (`stead_parent_gu_id`)
...
--     ON UPDATE NO ACTION;
ALTER TABLE `fiasdb`.`landmark`
  ADD CONSTRAINT `fk_landmark_address_object`
